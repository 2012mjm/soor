...
export function statusStyle (status, text) {
  if(status === 'pending') return <span>{text}</span>
  if(status === 'accepted') return <span>{text}</span>
  if(status === 'rejected') return <span>{text}</span>
  return text
}

export function statusInvoiceStyle (status, text) {
  if(status === 'pending') return <span>{text}</span>
  if(status === 'paid') return <span>{text}</span>
  if(status === 'sent') return <span>{text}</span>
  if(status === 'sent-final') return <span>{text}</span>
  if(status === 'rejected') return <span>{text}</span>
  return text
}
